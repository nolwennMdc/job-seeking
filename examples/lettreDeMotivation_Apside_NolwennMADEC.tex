...
\name{Nolwenn}{Madec}
\position{Etudiante ingénieure{\enskip\cdotp\enskip}Stage en étude et développement IoT}
...
\lettertitle{Candidature pour votre offre de stage " Ingénieur études et développement objets connectés - IoT "}
