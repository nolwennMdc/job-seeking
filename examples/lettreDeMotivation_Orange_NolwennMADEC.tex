...
\name{Nolwenn}{Madec}
\position{Etudiante ingénieure{\enskip\cdotp\enskip}Stage en développement Java/Android}
\address{83 rue des Jonquilles, 29760 PENMARC'H}
\dateofbirth{née le 14 Juin 1996}
%BIP : date de naissance, permis ... ?
\mobile{(+33) 645261992}
\email{nolwenn.madec29@orange.fr}
...
\recipient
  {Orange}
  {Ressources Humaines\\23 Avenue Georges Pompidou\\Lyon, 69003\\}
% The date on the letter, default is the date of compilation
\letterdate{Göteborg, le \today} 
% The title of the letter
\lettertitle{Candidature pour votre offre de stage "Ingénieur développement Java / Android"}
