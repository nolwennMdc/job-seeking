...
\name{Nolwenn}{Madec}
\position{Etudiante ingénieure{\enskip\cdotp\enskip}Stage en développement Web \& Mobile}
...
\recipient
  {Istep}
  {Etienne BAILLY\\Lyon, 69\\}
% The date on the letter, default is the date of compilation
\letterdate{Göteborg, le \today} 
% The title of the letter
\lettertitle{Candidature pour votre offre de stage " Stagiaire - Ingénieur - Développement Web \& Mobile "}
% How the letter is opened
\letteropening{Monsieur Bailly,}
